...
public class DataBaseConfig {
	...
	public DataSource getDataSource()
	{
		...
		dataSource.setUrl("jdbc:h2:tcp://localhost/~/srujana");
		dataSource.setUsername("srujana");
		dataSource.setPassword("computer9666");
		return dataSource;
	}
	//properties
	@Bean
    ...
    public SessionFactory  getSessionFactory()
    {
        ...
        localSessionFactoryBuilder.scanPackages("com.srujana.collabapibackend");
